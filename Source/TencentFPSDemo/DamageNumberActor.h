...
private:
	...
	UPROPERTY(ReplicatedUsing = OnRep_DamageInfo, VisibleInstanceOnly, Category = "DamageEffect")
	float DamageValue;

	UPROPERTY(ReplicatedUsing = OnRep_DamageInfo, VisibleInstanceOnly, Category = "DamageEffect")
	FLinearColor DamageColor;

	UPROPERTY(VisibleInstanceOnly, Category = "DamageEffect")
	float ElapsedTime;

	UFUNCTION()
	void OnRep_DamageInfo();
